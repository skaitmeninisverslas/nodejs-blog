         ...
         { this.state.posts.map(post =>
           <li className="card mt-2 p-3" key={post._id} value={post.title}>
              ...
              <div className="d-flex flex-column ml-auto border-left pl-4">
                <button data-toggle="modal" data-target={"#edit" + post.title} className="btn btn-primary">
                  <i className="fas fa-pen"></i>
                </button>
                <button data-toggle="modal" data-target={"#" + post.title} className="btn btn-danger mt-2">
            ...
            <div className="modal fade" id={post.title} tabIndex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div className="modal fade" id={'edit' + post.title} tabIndex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div className="modal-dialog modal-dialog-centered" role="document">
                <div className="modal-content">
                <form className="mt-4" action={"/api/post/edit/" + post._id} method="POST" encType="multipart/form-data">
                  ...
                  <div className="modal-body">
                     ...
                     <div className="form-group">
                        <label>Content</label>
                        <textarea className="form-control" name="content" placeholder="Content ..." cols="30" rows="10" defaultValue={post.content}></textarea>
                      </div>

                    <div className="form-group text-center">
                      <img src={'http://localhost:4000' + post.image} className="rounded" width="200" alt="" />
                      <input className="form-control-file mt-4" type="file" name="image" />
                    </div>
        ...
        <div className="modal-dialog modal-dialog-centered" role="document">
          ...
          <form className="mt-4" action="/api/posts/store" method="POST" encType="multipart/form-data">
            ...
            <div className="modal-body">
              ...
              <div className="form-group">
                <input className="form-control-file" required type="file" name="image" />
              </div>
